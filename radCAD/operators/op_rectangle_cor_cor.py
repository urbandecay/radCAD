...
class VIEW3D_OT_rectangle_cor_cor(bpy.types.Operator):
    bl_idname = "view3d.rectangle_cor_cor"
    bl_label = "Rectangle (Corner-Corner)"
    bl_options = {'REGISTER', 'UNDO'}

    def invoke(self, ctx, ev):
        state["tool_mode"] = "RECTANGLE_CORNER_CORNER"
