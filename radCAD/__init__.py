...
op_circle_tan_tan_tan_circles = _import("operators.op_circle_tan_tan_tan_circles") 
...
def register():
    ...
    bpy.utils.register_class(op_circle_tan_tan_tan_circles.VIEW3D_OT_circle_tan_tan_tan_circles) 
...
def unregister():
    ...
    bpy.utils.unregister_class(op_circle_tan_tan_tan_circles.VIEW3D_OT_circle_tan_tan_tan_circles) 
